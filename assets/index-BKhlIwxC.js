...
`;function Lx(){const[o,u]=le.useState(!1);return le.useEffect(()=>{const c=document.getElementById("python-scroll");if(!c)return;const l=()=>u(c.scrollTop>320);return c.addEventListener("scroll",l,{passive:!0}),l(),()=>c.removeEventListener("scroll",l)},[]),o?s.jsx(Ex,{type:"button","aria-label":"Scroll to top",title:"Scroll to top",onClick:()=>{var c;return(c=document.getElementById("python-scroll"))==null?void 0:c.scrollTo({top:0,behavior:"smooth"})},children:s.jsx(Gh,{"aria-hidden":"true"})}):null}const ji={Wrapper:E.section`
    ...
    `},Tx=()=>{const[o,u]=le.useState(!1),c=le.useMemo(()=>[{id:"what-is-python",icon:s.jsx(fo,{}),title:"What is Python",summary:"Python is a high-level language focused on readability and fast development.",points:["High-level means you write human-friendly code, not low-level machine instructions.","Python is used for scripting, web, automation, data, tooling, digital tooling, and backend services.","Python code is usually executed by CPython (the most common interpreter)."],example:`# Python reads like plain English
name = "Ash"
age = 25
